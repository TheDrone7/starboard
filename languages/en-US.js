...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			INHIBITOR_MISSING_BOT_PERMS: (missing) => `Insufficient permissions.\nPlease give me the following permissions to use this command: \`${missing}\``,
			...
			COMMAND_CHANNEL_DESCRIPTION: 'Changes the channel to be used for starboard tp the provided channel',
